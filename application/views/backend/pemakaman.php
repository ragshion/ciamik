            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">
                        <i class="far fa-plus-hexagon"></i> Tambah Data Pemakaman
                    </h4>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="<?=base_url('pemakaman/save')?>" enctype='multipart/form-data'>
                        <div class="form-group">
                            <label class="form-label">Nama Pemakaman</label>
                            <input type="text" name="nama_pemakaman" class="form-control" required="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="form-label">Tarif Retribusi (Rp.)</label>
                            <input type="number" name="tarif_retribusi" class="form-control" required="">
                        </div>
                        <div class="form-group">
    ...
    <div class="modal fade" id="modal-edit" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">
                        <i class="far fa-plus-hexagon"></i> Edit Data Pemakaman
                    </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><i class="fal fa-times"></i></span>
                    </button>
                ...
                <div class="modal-body">
                    <form method="post" action="<?=base_url('pemakaman/update')?>" enctype='multipart/form-data'>
                        <input type="hidden" name="xid" id="xid">
                        <div class="form-group">
                            <label class="form-label">Nama Pemakaman</label>
                            <input type="text" name="nama_pemakaman" id="nama_pemakaman" class="form-control" required="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="form-label">Tarif Retribusi (Rp.)</label>
                            <input type="number" name="tarif_retribusi" id="tarif_retribusi" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Koordinat</label>
                            <div class="row">
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        <i class="far fa-image"></i> Tabel <span class="fw-300"><i>Pemakaman</i></span>
                    </h2>
                </div>
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="panel-tag">
                            Data Pemakaman yang ada di Kabupaten Batang
                        </div>
                        <?= $this->session->flashdata('alert'); ?>
                        <button data-toggle="modal" data-target="#modal-tambah" type="button" class="btn btn-primary"><i class="far fa-plus-hexagon"></i> Tambah Data Pemakaman</button>
                        <hr>
                        <!-- datatable start -->
                            ...
                            <tbody>
                                <?php $no=1; foreach ($data as $d): ?>
                                    <tr>
                                        ...
                                        <td><?=$d['lokasi']?></td>
                                        <td><?=$d['tarif_retribusi']?></td>
                                        <td><?=$d['luas']?> m<sup>2</sup></td>
                                        <td><a href="<?=base_url('uploads/').$d['foto']?>" target="_blank"><img height="100" src="<?=base_url('uploads/').$d['foto']?>"></a></td>
                                        <td>
                                            <a href="javascript:;" class="btn btn-secondary btn-icon rounded-circle" onclick="edit_pemakaman('<?=$d['id']?>')"><i class="far fa-edit"></i></a>
                                            <a href="javascript:;" class="btn btn-danger btn-icon rounded-circle del" rel="<?=base_url('pemakaman/hapus/').$d['id']?>"><i class="far fa-trash"></i></a>
                                        </td>
