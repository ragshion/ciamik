...
class Rtlh extends CI_Controller {
	...
	public function index(){
		$r = $this->db->order_by('tgl_input','desc')->get('rtlh')->result_array();
		foreach ($r as $x) {
		...
		$this->load->view('backend/rtlh',$data);
	...
	function save(){
		...
		if(!empty($_FILES['userFiles']['name'])){
            ...
            $this->db->insert('rtlh',$data);

            $this->session->set_flashdata('alert','<div class="alert alert-primary alert-dismissible fade show" role="alert"> <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true"><i class="far fa-info"></i></span> </button> <strong>Berhasil!</strong> Data RTLH berhasil disimpan.</div>');
